 ...
 * @Date 2019/6/14 0:18
 *****/
@Api(value = "AddressController111",tags="tags1",description = "API管理测试")
@RestController
...
public class AddressController {
     ...
     * @return
     */
    @ApiOperation(value = "Address条件分页查询",notes = "分页条件查询Address方法详情")
    @ApiImplicitParams({
     ...
     * @return
     */
    @ApiOperation(value = "Address分页查询",notes = "分页查询Address方法详情")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path", name = "page", value = "当前页", required = true, dataType = "Integer"),
            @ApiImplicitParam(paramType = "path", name = "size", value = "每页显示条数", required = true, dataType = "Integer")
    })
     ...
     * @return
     */
    @ApiOperation(value = "Address条件查询",notes = "条件查询Address方法详情")
     ...
     * @return
     */
    @ApiOperation(value = "Address根据ID删除",notes = "根据ID删除Address方法详情")
     ...
     * @return
     */
    @ApiOperation(value = "Address根据ID修改",notes = "根据ID修改Address方法详情")
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Integer")
    @PutMapping(value="/{id}")
     ...
     * @return
     */
    @ApiOperation(value = "Address添加",notes = "添加Address方法详情")
    @PostMapping
     ...
     * @return
     */
    @ApiOperation(value = "Address根据ID查询",notes = "根据ID查询Address方法详情")
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Integer")
    @GetMapping("/{id}")
     ...
     * @return
     */
    @ApiOperation(value = "查询所有Address",notes = "查询所Address有方法详情")
    @GetMapping
    public Result<List<Address>> findAll(){
    	logger.debug("findAll->{}",1);
